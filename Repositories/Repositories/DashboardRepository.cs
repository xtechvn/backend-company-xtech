...
namespace Repositories.Repositories
{
    public class DashboardRepository : BaseRepository, IDashboardRepository
    {
        ...
        public DashboardRepository(IHttpContextAccessor context, IOptions<DataBaseConfig> dataBaseConfig, IUserRepository userRepository, IConfiguration configuration, RedisConn redisConn) : base(context, dataBaseConfig, configuration, userRepository,redisConn)
        {
