...
namespace Repositories.Repositories
{
    public class MenuRepository : BaseRepository, IMenuRepository
    {
        ...
        public MenuRepository(IHttpContextAccessor context, IOptions<DataBaseConfig> dataBaseConfig, IUserRepository userRepository, IConfiguration configuration, RedisConn redisConn) : base(context, dataBaseConfig, configuration, userRepository, redisConn)
        {
