...
namespace Repositories.IRepositories
{
    public class DepartmentRepository : BaseRepository, IDepartmentRepository
    {
        ...
        public DepartmentRepository(IHttpContextAccessor context, IOptions<DataBaseConfig> dataBaseConfig, IUserRepository userRepository, IConfiguration configuration, RedisConn redisConn) : base(context, dataBaseConfig, configuration, userRepository,redisConn)
        {
        ...
        public async Task<long> Create(Department model)
        {
            try
            {
                ...
                return await _DepartmentDAL.CreateAsync(model);
            }
            catch
            {
                throw;
