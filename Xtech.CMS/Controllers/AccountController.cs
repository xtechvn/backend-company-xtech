...
namespace WEB.CMS.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Logout()
        {
            ...
            return Redirect(_configuration["Setting:HomeURL"]);
        ...
        public IActionResult RedirectLogin()
        {
            ...
            if (_configuration["Setting:On_QC_Environment"]!=null && _configuration["Setting:On_QC_Environment"].Trim()=="1")
            {
        ...
        public async Task<IActionResult> LoginWithToken(string token_user)
        {
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token_user.Replace("_", @"/").Replace("-", "+"), out objParr, _configuration["DataBaseConfig:key_api:api_manual"]))
                {
                    ...
                    int token_exprire = Convert.ToInt32(_configuration["Setting:LoginTokenExprire"]);
        ...
        public async Task<IActionResult> Setup2FA()
        {
            try
            {
                ...
                if (token != null && token.Trim() != "")
                {
                    ...
                    UserLoginModel login_model = MFAService.DecryptLoginModelFromToken(token,_configuration);
                    if (login_model != null && login_model.id > 0 && DateTime.Now < login_model.date && login_model.ip == remoteIpAddress.ToString())
                    {
                        ...
                        string enviroment = _configuration["Setting:OTP_Enviroment"];
