    ...
    public class CustomerManagerController : Controller
    {
        ...
        public async Task<IActionResult> Detail(int id)
        {
            try
            {
                ...
                if (model != null && model.ClientType != Ultilities.Constants.ClientType.KL)
                {
                    ViewBag.btnStatus = 1;
                }
                ViewBag.id = id;
        ...
        public async Task<IActionResult> SendMailResetPasswordb2b(long id)
        {
            ...
            try
            {
                ...
                var model = await _clientRepository.GetClientDetailByClientId((int)id);
                ...
                if (Ac != null && model != null && model.ClientType != Ultilities.Constants.ClientType.KL)
                {
