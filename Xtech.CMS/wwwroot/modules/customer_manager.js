...
$(document).ready(function () {
    ...
    $(document).click(function () {
        if ($(event.target).closest('#button-filter').length == 0) {
            var buttonFilter = $("#button-filter");
            var bodyFilter = $("#body-filter");
            buttonFilter.removeClass('active');
            bodyFilter.addClass('hidden-filter');
        } 
        if ($(event.target).closest('#datefilter').length == 0) {
            var buttondate = $("#button-date");
            var bodydate = $("#date-body-filter");
            buttondate.removeClass('active');
            bodydate.addClass('date-filter');
        }
...
var _customer_manager = {
    ...
    showBodyFilter: function ()
    {
        var buttonFilter = $("#button-filter");
        var bodyFilter = $("#body-filter");
        if (buttonFilter.hasClass('active'))
        {
            buttonFilter.removeClass('active');
            bodyFilter.addClass('hidden-filter');
        }
        else
        {
            ...
            bodyFilter.removeClass('hidden-filter');
        }
    },
    showDateFilter: function () {
        ...
        if (buttondate.hasClass('active')) {
            ...
            buttondate.addClass('active');
            bodydate.removeClass('date-filter');
        }
    }
    ,
