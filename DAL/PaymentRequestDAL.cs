...
namespace DAL
{
    public class PaymentRequestDAL : GenericService<PaymentRequest>
    {
        ...
        public PaymentRequest GetById2(long paymentRequestId)
        {
            try
            {
                using (var _DbContext = new EntityDataContext(_connection))
        ...
        public int UpdatePaymentRequest(PaymentRequestViewModel model)
        {
            ...
            try
            {
                SqlParameter[] objParam_paymentRequest = new SqlParameter[21];
        ...
        public DataTable GetListPaymentRequestByClientId(long clientId, long Type, string proc)
        {
            try
            {
                SqlParameter[] objParam = new SqlParameter[2];
        ...
        public int ApproveRequest(PaymentRequest model)
        {
            try
            {
                ...
                objParam[2] = new SqlParameter("@OrderStatus", (int)OrderStatus.Completed);
        ...
        public int CreatePaymentRequest(PaymentRequestViewModel model)
        {
            ...
            try
            {
                SqlParameter[] objParam_paymentRequest = new SqlParameter[17];
